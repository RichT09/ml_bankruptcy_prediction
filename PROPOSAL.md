...
The analysis will rely exclusively on a structured U.S. public company dataset, covering the period from 1995 to 2024. To ensure a robust and realistic evaluation, I will use a time-based split: training from 1995-2014 and testing from 2014-2023. 
